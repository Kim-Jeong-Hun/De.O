...
const FEATURES = [
  { number: "01", icon: "⇄", title: "가격표 너머, 진짜 최저가", desc: "같은 용량과 호수인지, 배송비는 얼마인지. 흩어진 조건을 모아 실제로 비교할 수 있는 가격을 보여드릴게요.", label: "같은 용량·호수 · 배송비 포함", kind: "compare" },
          ...
          {FEATURES.map((feature) => (
            <article key={feature.number} className={styles.card}>
              ...
              <div className={styles.visual} aria-hidden="true">
                {feature.kind === "compare" ? <><div><span>A 쇼핑몰</span><b>29,400원 <small>최저가</small></b></div><div><span>B 쇼핑몰</span><b>31,000원</b></div></> : feature.kind === "history" ? <svg viewBox="0 0 290 88"><path d="M0 22h290M0 48h290M0 74h290" stroke="#eee0e5" strokeDasharray="4 4" /><path d="M5 26h35v14h33V22h36v35h33V45h35v15h37v-9h30v24h40" fill="none" stroke="#cf5078" strokeWidth="3" strokeLinejoin="round" /><circle cx="284" cy="75" r="5" fill="#cf5078" /></svg> : <div className={styles.miniAlert}><span>↘</span><div><b>목표 가격에 도착했어요</b><p>이제 기분 좋게 쇼핑할 시간!</p></div></div>}
              </div>
